...
export class AnalyticsComponent implements OnInit {
  ...
  heading = 'Estadísticas de BookApp Business';
  subheading = 'Información de gestión la operación.';
  ...
  constructor(
         ...
         (
             (data : any) =>   {
               ...
               for( var i = 0; i<this.pedidosArray$.length; i++ ){
                 ...
                 if( this.pedidosArray$[i].status === 3 ){
                 ...
                 if(this.pedidosArray$[i].negocio){
                   ...
                   if(this.pedidosArray$[i].negocio._id){
                   ...
                   this.pedidosArrayExcel$.push({
                     ...
                     "negocio" : this.pedidosArray$[i].negocio.nombre,
                     "cliente" : this.pedidosArray$[i].usuario.nombre,
                     "servicio" : this.pedidosArray$[i].pideloquequieras ? "Pide lo que quieras" : this.pedidosArray$[i].tipo_servicio === 1 ? "Entrega en tienda" : this.pedidosArray$[i].tipo_servicio === 2 ? "Entrega a domicilio" : "-",
                     "profesional" : this.pedidosArray$[i].motofast ? this.pedidosArray$[i].motofast.nombre : "-",
                     ...
                     "articulos" : this.pedidosArray$[i].platillos.length,
                     "estado" :
   ...
   exportarUsuariosXls(){
     const worksheet: XLSX.WorkSheet = XLSX.utils.json_to_sheet(this.usuariosArrayExcel$);
     const workbook: XLSX.WorkBook = {Sheets: {'data': worksheet}, SheetNames: ['data']};
     ...
     .subscribe
       (
           (data : any) =>   {
             ...
             for( var i = 0; i<data.data.length; i++ ){
               this.usuariosArrayExcel$.push({
                 "correo" : data.data[i].correo,
                 "nombre" : data.data[i].nombre,
                 "telefono" : data.data[i].telefono,
                 "tipo_usuario" : data.data[i].tipo_usuario.descripcion,
                 "negocio" : data.data[i].sucursal ? data.data[i].sucursal.nombre : "",
               });
             }
           },
           error =>  {
